...
public class CloudBlueHeadbandItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:cloud_blue_headband_helmet")
	public static final Item helmet = null;
	@ObjectHolder("naruto_unleashed:cloud_blue_headband_chestplate")
	public static final Item body = null;
	@ObjectHolder("naruto_unleashed:cloud_blue_headband_leggings")
	public static final Item legs = null;
	@ObjectHolder("naruto_unleashed:cloud_blue_headband_boots")
	public static final Item boots = null;

	public CloudBlueHeadbandItem(NarutoUnleashedModElements instance) {
		super(instance, 587);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "naruto_unleashed:textures/cloudvillage_headband_blue.png";
			}
		}.setRegistryName("cloud_blue_headband_helmet"));
	}

...
import net.mcreator.narutounleashed.entity.renderer.SenbonRenderer;
...
public class SenbonItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:senbon")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletsenbon").setRegistryName("entitybulletsenbon");

	public SenbonItem(NarutoUnleashedModElements instance) {
		super(instance, 411);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SenbonRenderer.ModelRegisterHandler());
	}

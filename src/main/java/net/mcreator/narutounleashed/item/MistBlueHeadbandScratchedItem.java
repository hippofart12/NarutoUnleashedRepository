...
public class MistBlueHeadbandScratchedItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:mist_blue_headband_scratched_helmet")
	public static final Item helmet = null;
	@ObjectHolder("naruto_unleashed:mist_blue_headband_scratched_chestplate")
	public static final Item body = null;
	@ObjectHolder("naruto_unleashed:mist_blue_headband_scratched_leggings")
	public static final Item legs = null;
	@ObjectHolder("naruto_unleashed:mist_blue_headband_scratched_boots")
	public static final Item boots = null;

	public MistBlueHeadbandScratchedItem(NarutoUnleashedModElements instance) {
		super(instance, 598);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public String getName() {
				return "mist_blue_headband_scratched";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "naruto_unleashed:textures/mistvillage_headband_blue_scratched.png";
			}
		}.setRegistryName("mist_blue_headband_scratched_helmet"));
	}

...
public class SasoriRingItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:sasori_ring")
	public static final Item block = null;

	public SasoriRingItem(NarutoUnleashedModElements instance) {
		super(instance, 433);
	}

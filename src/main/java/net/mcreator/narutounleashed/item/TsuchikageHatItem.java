...
public class TsuchikageHatItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:tsuchikage_hat_helmet")
	public static final Item helmet = null;
	@ObjectHolder("naruto_unleashed:tsuchikage_hat_chestplate")
	public static final Item body = null;
	@ObjectHolder("naruto_unleashed:tsuchikage_hat_leggings")
	public static final Item legs = null;
	@ObjectHolder("naruto_unleashed:tsuchikage_hat_boots")
	public static final Item boots = null;

	public TsuchikageHatItem(NarutoUnleashedModElements instance) {
		super(instance, 655);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "naruto_unleashed:textures/tsuchikage_hat.png";
			}
		}.setRegistryName("tsuchikage_hat_helmet"));
	}

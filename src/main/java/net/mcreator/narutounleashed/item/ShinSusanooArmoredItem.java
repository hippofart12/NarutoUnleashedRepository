...
public class ShinSusanooArmoredItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:shin_susanoo_armored_helmet")
	public static final Item helmet = null;
	@ObjectHolder("naruto_unleashed:shin_susanoo_armored_chestplate")
	public static final Item body = null;
	@ObjectHolder("naruto_unleashed:shin_susanoo_armored_leggings")
	public static final Item legs = null;
	@ObjectHolder("naruto_unleashed:shin_susanoo_armored_boots")
	public static final Item boots = null;

	public ShinSusanooArmoredItem(NarutoUnleashedModElements instance) {
		super(instance, 904);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab)) {
			...
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				...
				armorModel.bipedBody = new Models_danett3().Armored;
				armorModel.bipedLeftArm = new Models_danett3().bone53;
				armorModel.bipedRightArm = new Models_danett3().bone53;
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "naruto_unleashed:textures/s_danett3.png";
			}
		}.setRegistryName("shin_susanoo_armored_chestplate"));
	}

	// Made with Blockbench 3.8.4
	// Exported for Minecraft version 1.15 - 1.16
	// Paste this class into your mod and generate all required imports
	public static class Models_danett3 extends EntityModel<Entity> {
		...
		public Models_danett3() {
			textureWidth = 512;
			textureHeight = 512;
			Armored = new ModelRenderer(this);
			Armored.setRotationPoint(0.0F, -17.5F, 0.0F);
			bone = new ModelRenderer(this);
			bone.setRotationPoint(1.9F, 29.5F, 0.0F);
			Armored.addChild(bone);
			...
			bone42.setTextureOffset(164, 75).addBox(0.7695F, -55.9914F, -20.0F, 9.0F, 3.0F, 10.0F, 0.0F, false);
			bone42.setTextureOffset(164, 75).addBox(2.7695F, -56.9914F, -19.0F, 4.0F, 4.0F, 9.0F, 0.0F, false);
			bone47 = new ModelRenderer(this);
			bone47.setRotationPoint(0.0F, 0.0F, 0.0F);
			bone42.addChild(bone47);
			bone47.setTextureOffset(164, 75).addBox(8.7695F, -52.9914F, -20.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
			bone47.setTextureOffset(164, 75).addBox(6.7695F, -52.9914F, -20.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			bone47.setTextureOffset(164, 75).addBox(2.7695F, -52.9914F, -20.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			bone47.setTextureOffset(164, 75).addBox(4.7695F, -52.9914F, -20.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			bone47.setTextureOffset(164, 75).addBox(8.7695F, -52.9914F, -18.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			bone47.setTextureOffset(164, 75).addBox(0.7695F, -52.9914F, -18.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			bone47.setTextureOffset(164, 75).addBox(8.7695F, -52.9914F, -16.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			bone47.setTextureOffset(164, 75).addBox(0.7695F, -52.9914F, -16.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			bone47.setTextureOffset(164, 75).addBox(8.7695F, -52.9914F, -14.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			bone47.setTextureOffset(164, 75).addBox(0.7695F, -52.9914F, -14.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			bone48 = new ModelRenderer(this);
			bone48.setRotationPoint(-8.0F, 0.0F, 0.0F);
			bone42.addChild(bone48);
			bone48.setTextureOffset(164, 75).addBox(8.7695F, -52.9914F, -20.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
			bone49 = new ModelRenderer(this);
			bone49.setRotationPoint(9.2695F, -54.4914F, -18.5F);
			bone42.addChild(bone49);
			setRotationAngle(bone49, 0.0F, -0.3927F, 0.0F);
			bone49.setTextureOffset(164, 75).addBox(-0.5F, -0.5F, -0.5F, 3.0F, 1.0F, 1.0F, 0.0F, false);
			bone49.setTextureOffset(164, 75).addBox(5.8128F, -0.5F, 0.9546F, 3.0F, 1.0F, 1.0F, 0.0F, false);
			bone51 = new ModelRenderer(this);
			bone51.setRotationPoint(-11.7305F, -54.4914F, -20.5F);
			bone42.addChild(bone51);
			setRotationAngle(bone51, 0.0F, 0.3927F, 0.0F);
			bone51.setTextureOffset(164, 75).addBox(1.8611F, -0.5F, 8.2851F, 3.0F, 1.0F, 1.0F, 0.0F, false);
			bone51.setTextureOffset(164, 75).addBox(8.1739F, -0.5F, 6.8305F, 3.0F, 1.0F, 1.0F, 0.0F, false);
			bone50 = new ModelRenderer(this);
			bone50.setRotationPoint(13.2695F, -54.4914F, -18.5F);
			bone42.addChild(bone50);
			setRotationAngle(bone50, 0.0F, -0.7854F, 0.0F);
			bone50.setTextureOffset(164, 75).addBox(-0.7101F, -0.5F, 1.4098F, 4.0F, 1.0F, 1.0F, 0.0F, false);
			bone52 = new ModelRenderer(this);
			bone52.setRotationPoint(-4.7305F, -54.4914F, -18.5F);
			bone42.addChild(bone52);
			setRotationAngle(bone52, 0.0F, 0.7854F, 0.0F);
			bone52.setTextureOffset(164, 75).addBox(-2.5977F, -0.5F, 3.0746F, 4.0F, 1.0F, 1.0F, 0.0F, false);
			...
			bone2.setRotationPoint(11.9F, 31.5F, 1.0F);
			Armored.addChild(bone2);
			...
			bone7.setRotationPoint(-48.1F, 31.5F, 1.0F);
			Armored.addChild(bone7);
			...
			bone8.setRotationPoint(5.0F, -3.5F, -4.0F);
			Armored.addChild(bone8);
			...
			bone72.setRotationPoint(-4.0F, 50.5F, 6.0F);
			Armored.addChild(bone72);
			...
			bone76.setRotationPoint(-5.0F, 50.5F, 6.0F);
			Armored.addChild(bone76);
			...
			bone78.setRotationPoint(-20.0F, 47.5F, 7.0F);
			Armored.addChild(bone78);
			...
			bone80.setRotationPoint(24.0F, 45.5F, 6.0F);
			Armored.addChild(bone80);
			...
			bone45.setRotationPoint(0.0F, 41.5F, 0.0F);
			Armored.addChild(bone45);
			bone45.setTextureOffset(212, 467).addBox(-19.0F, -68.0F, -22.0F, 3.0F, 65.0F, 3.0F, 0.0F, false);
			bone45.setTextureOffset(212, 467).addBox(-26.0058F, -63.2315F, -22.0F, 3.0F, 7.0F, 3.0F, 0.0F, false);
			bone45.setTextureOffset(212, 467).addBox(-12.0058F, -63.2315F, -22.0F, 3.0F, 7.0F, 3.0F, 0.0F, false);
			bone45.setTextureOffset(212, 467).addBox(-24.0F, -52.0F, -22.0F, 5.0F, 3.0F, 3.0F, 0.0F, false);
			bone45.setTextureOffset(212, 467).addBox(-16.0F, -52.0F, -22.0F, 5.0F, 3.0F, 3.0F, 0.0F, false);
			bone11 = new ModelRenderer(this);
			bone11.setRotationPoint(0.0F, 0.0F, 0.0F);
			bone45.addChild(bone11);
			setRotationAngle(bone11, 0.0F, 0.0F, 0.7854F);
			bone11.setTextureOffset(212, 467).addBox(-55.6188F, -20.6777F, -22.0F, 4.0F, 3.0F, 3.0F, 0.0F, false);
			bone11.setTextureOffset(212, 467).addBox(-45.4264F, -30.8701F, -22.0F, 3.0F, 4.0F, 3.0F, 0.0F, false);
			bone43 = new ModelRenderer(this);
			bone43.setRotationPoint(19.0F, -51.0F, 0.0F);
			bone45.addChild(bone43);
			setRotationAngle(bone43, 0.0F, 0.0F, 0.1745F);
			bone43.setTextureOffset(212, 467).addBox(-45.276F, 2.1422F, -22.0F, 3.0F, 5.0F, 3.0F, 0.0F, false);
			bone44 = new ModelRenderer(this);
			bone44.setRotationPoint(19.0F, -51.0F, 0.0F);
			bone45.addChild(bone44);
			setRotationAngle(bone44, 0.0F, 0.0F, -0.1745F);
			bone44.setTextureOffset(212, 467).addBox(-29.6149F, -10.5341F, -22.0F, 3.0F, 5.0F, 3.0F, 0.0F, false);
			bone46 = new ModelRenderer(this);
			bone46.setRotationPoint(39.7979F, 49.9344F, 14.8323F);
			Armored.addChild(bone46);
			setRotationAngle(bone46, 1.5708F, 0.0F, -3.1416F);
			bone46.setTextureOffset(298, 186).addBox(11.1233F, -40.8132F, -37.3251F, 9.0F, 4.0F, 11.0F, 0.0F, false);
			...
			bone41.setRotationPoint(0.037F, 3.4325F, -57.6326F);
		...
		public void render(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue,
				float alpha) {
			Armored.render(matrixStack, buffer, packedLight, packedOverlay);
			bone53.render(matrixStack, buffer, packedLight, packedOverlay);
		}

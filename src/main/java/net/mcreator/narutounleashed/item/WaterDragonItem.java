...
import net.mcreator.narutounleashed.entity.renderer.WaterDragonRenderer;
import net.mcreator.narutounleashed.NarutoUnleashedModElements;

import java.util.Random;

@NarutoUnleashedModElements.ModElement.Tag
public class WaterDragonItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:water_dragon")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletwater_dragon").setRegistryName("entitybulletwater_dragon");

	public WaterDragonItem(NarutoUnleashedModElements instance) {
		super(instance, 1607);

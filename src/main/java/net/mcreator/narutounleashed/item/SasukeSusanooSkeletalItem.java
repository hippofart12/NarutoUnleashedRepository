...
import net.mcreator.narutounleashed.procedures.SSSTickProcedure;
...
public class SasukeSusanooSkeletalItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:sasuke_susanoo_skeletal_helmet")
	public static final Item helmet = null;
	@ObjectHolder("naruto_unleashed:sasuke_susanoo_skeletal_chestplate")
	public static final Item body = null;
	@ObjectHolder("naruto_unleashed:sasuke_susanoo_skeletal_leggings")
	public static final Item legs = null;
	@ObjectHolder("naruto_unleashed:sasuke_susanoo_skeletal_boots")
	public static final Item boots = null;

	public SasukeSusanooSkeletalItem(NarutoUnleashedModElements instance) {
		super(instance, 890);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public String getName() {
				return "sasuke_susanoo_skeletal";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "naruto_unleashed:textures/s_sasuke2.png";
			}
			...
			public void onArmorTick(ItemStack itemstack, World world, PlayerEntity entity) {
				...
				SSSTickProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x),
						new AbstractMap.SimpleEntry<>("y", y), new AbstractMap.SimpleEntry<>("z", z), new AbstractMap.SimpleEntry<>("entity", entity))
						.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			}
		}.setRegistryName("sasuke_susanoo_skeletal_chestplate"));
	}

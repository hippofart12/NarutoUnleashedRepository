...
public class SteelIngotItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:steel_ingot")
	public static final Item block = null;

	public SteelIngotItem(NarutoUnleashedModElements instance) {
		super(instance, 7);
	}

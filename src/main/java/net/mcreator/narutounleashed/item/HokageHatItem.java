...
public class HokageHatItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:hokage_hat_helmet")
	public static final Item helmet = null;
	@ObjectHolder("naruto_unleashed:hokage_hat_chestplate")
	public static final Item body = null;
	@ObjectHolder("naruto_unleashed:hokage_hat_leggings")
	public static final Item legs = null;
	@ObjectHolder("naruto_unleashed:hokage_hat_boots")
	public static final Item boots = null;

	public HokageHatItem(NarutoUnleashedModElements instance) {
		super(instance, 652);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "naruto_unleashed:textures/hokage_hat.png";
			}
		}.setRegistryName("hokage_hat_helmet"));
	}

...
public class TobisMaskItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:tobis_mask_helmet")
	public static final Item helmet = null;
	@ObjectHolder("naruto_unleashed:tobis_mask_chestplate")
	public static final Item body = null;
	@ObjectHolder("naruto_unleashed:tobis_mask_leggings")
	public static final Item legs = null;
	@ObjectHolder("naruto_unleashed:tobis_mask_boots")
	public static final Item boots = null;

	public TobisMaskItem(NarutoUnleashedModElements instance) {
		super(instance, 642);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{2, 5, 6, 8}[slot.getIndex()];
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab)) {
			...
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				...
				armorModel.bipedHead = new ModelTobiMask().bipedHead;
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "naruto_unleashed:textures/tobimask.png";
			}
		}.setRegistryName("tobis_mask_helmet"));
	}

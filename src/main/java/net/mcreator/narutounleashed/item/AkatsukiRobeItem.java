...
public class AkatsukiRobeItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:akatsuki_robe_helmet")
	public static final Item helmet = null;
	@ObjectHolder("naruto_unleashed:akatsuki_robe_chestplate")
	public static final Item body = null;
	@ObjectHolder("naruto_unleashed:akatsuki_robe_leggings")
	public static final Item legs = null;
	@ObjectHolder("naruto_unleashed:akatsuki_robe_boots")
	public static final Item boots = null;

	public AkatsukiRobeItem(NarutoUnleashedModElements instance) {
		super(instance, 395);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "naruto_unleashed:textures/r9.png";
			}
		}.setRegistryName("akatsuki_robe_chestplate"));
	}

...
public class PainsRingItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:pains_ring")
	public static final Item block = null;

	public PainsRingItem(NarutoUnleashedModElements instance) {
		super(instance, 579);
	}

...
public class LeafBlackHeadbandItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:leaf_black_headband_helmet")
	public static final Item helmet = null;
	@ObjectHolder("naruto_unleashed:leaf_black_headband_chestplate")
	public static final Item body = null;
	@ObjectHolder("naruto_unleashed:leaf_black_headband_leggings")
	public static final Item legs = null;
	@ObjectHolder("naruto_unleashed:leaf_black_headband_boots")
	public static final Item boots = null;

	public LeafBlackHeadbandItem(NarutoUnleashedModElements instance) {
		super(instance, 137);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "naruto_unleashed:textures/leafvillage_headband_black.png";
			}
		}.setRegistryName("leaf_black_headband_helmet"));
	}

...
public class KonansRingItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:konans_ring")
	public static final Item block = null;

	public KonansRingItem(NarutoUnleashedModElements instance) {
		super(instance, 485);
	}

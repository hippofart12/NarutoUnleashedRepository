...
public class YellowAnbuMaskItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:yellow_anbu_mask_helmet")
	public static final Item helmet = null;
	@ObjectHolder("naruto_unleashed:yellow_anbu_mask_chestplate")
	public static final Item body = null;
	@ObjectHolder("naruto_unleashed:yellow_anbu_mask_leggings")
	public static final Item legs = null;
	@ObjectHolder("naruto_unleashed:yellow_anbu_mask_boots")
	public static final Item boots = null;

	public YellowAnbuMaskItem(NarutoUnleashedModElements instance) {
		super(instance, 645);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "naruto_unleashed:textures/yellowanbumask.png";
			}
		}.setRegistryName("yellow_anbu_mask_helmet"));
	}

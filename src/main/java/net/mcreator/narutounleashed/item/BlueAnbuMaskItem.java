...
public class BlueAnbuMaskItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:blue_anbu_mask_helmet")
	public static final Item helmet = null;
	@ObjectHolder("naruto_unleashed:blue_anbu_mask_chestplate")
	public static final Item body = null;
	@ObjectHolder("naruto_unleashed:blue_anbu_mask_leggings")
	public static final Item legs = null;
	@ObjectHolder("naruto_unleashed:blue_anbu_mask_boots")
	public static final Item boots = null;

	public BlueAnbuMaskItem(NarutoUnleashedModElements instance) {
		super(instance, 643);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "naruto_unleashed:textures/blueanbumask.png";
			}
		}.setRegistryName("blue_anbu_mask_helmet"));
	}

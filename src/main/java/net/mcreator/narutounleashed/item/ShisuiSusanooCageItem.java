...
import net.mcreator.narutounleashed.procedures.SHSCTickProcedure;
...
public class ShisuiSusanooCageItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:shisui_susanoo_cage_helmet")
	public static final Item helmet = null;
	@ObjectHolder("naruto_unleashed:shisui_susanoo_cage_chestplate")
	public static final Item body = null;
	@ObjectHolder("naruto_unleashed:shisui_susanoo_cage_leggings")
	public static final Item legs = null;
	@ObjectHolder("naruto_unleashed:shisui_susanoo_cage_boots")
	public static final Item boots = null;

	public ShisuiSusanooCageItem(NarutoUnleashedModElements instance) {
		super(instance, 889);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab)) {
			...
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				...
				armorModel.bipedRightArm = new ModelSusanooCage().bone;
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "naruto_unleashed:textures/susanoo_shisui1.png";
			}
			...
			public void onArmorTick(ItemStack itemstack, World world, PlayerEntity entity) {
				...
				SHSCTickProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x),
						new AbstractMap.SimpleEntry<>("y", y), new AbstractMap.SimpleEntry<>("z", z), new AbstractMap.SimpleEntry<>("entity", entity))
						.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			}
		}.setRegistryName("shisui_susanoo_cage_chestplate"));
	}

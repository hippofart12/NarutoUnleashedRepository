...
public class RockRedHeadbandScratchedItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:rock_red_headband_scratched_helmet")
	public static final Item helmet = null;
	@ObjectHolder("naruto_unleashed:rock_red_headband_scratched_chestplate")
	public static final Item body = null;
	@ObjectHolder("naruto_unleashed:rock_red_headband_scratched_leggings")
	public static final Item legs = null;
	@ObjectHolder("naruto_unleashed:rock_red_headband_scratched_boots")
	public static final Item boots = null;

	public RockRedHeadbandScratchedItem(NarutoUnleashedModElements instance) {
		super(instance, 612);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public String getName() {
				return "rock_red_headband_scratched";
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "naruto_unleashed:textures/rockvillage_headband_red_-_scratched.png";
			}
		}.setRegistryName("rock_red_headband_scratched_helmet"));
	}

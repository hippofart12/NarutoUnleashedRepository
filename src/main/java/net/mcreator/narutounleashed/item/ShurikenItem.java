...
import net.mcreator.narutounleashed.procedures.ShurikenCanUseRangedItemProcedure;
import net.mcreator.narutounleashed.itemgroup.NarutoUnleashedTabItemGroup;
import net.mcreator.narutounleashed.entity.renderer.ShurikenRenderer;
...
public class ShurikenItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:shuriken")
	...
	public ShurikenItem(NarutoUnleashedModElements instance) {
		super(instance, 502);
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (ShurikenCanUseRangedItemProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
						.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1.4f, 4, 0);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(PaperShurikenItem.block);
		}

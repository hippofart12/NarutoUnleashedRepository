...
import net.mcreator.narutounleashed.entity.renderer.WoodSpikeRenderer;
import net.mcreator.narutounleashed.NarutoUnleashedModElements;

import java.util.Random;

@NarutoUnleashedModElements.ModElement.Tag
public class WoodSpikeItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:wood_spike")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletwood_spike").setRegistryName("entitybulletwood_spike");

	public WoodSpikeItem(NarutoUnleashedModElements instance) {
		super(instance, 516);
		FMLJavaModLoadingContext.get().getModEventBus().register(new WoodSpikeRenderer.ModelRegisterHandler());
	}

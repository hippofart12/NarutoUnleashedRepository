...
public class KazekageHatItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:kazekage_hat_helmet")
	public static final Item helmet = null;
	@ObjectHolder("naruto_unleashed:kazekage_hat_chestplate")
	public static final Item body = null;
	@ObjectHolder("naruto_unleashed:kazekage_hat_leggings")
	public static final Item legs = null;
	@ObjectHolder("naruto_unleashed:kazekage_hat_boots")
	public static final Item boots = null;

	public KazekageHatItem(NarutoUnleashedModElements instance) {
		super(instance, 653);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "naruto_unleashed:textures/kazekage_hat.png";
			}
		}.setRegistryName("kazekage_hat_helmet"));
	}

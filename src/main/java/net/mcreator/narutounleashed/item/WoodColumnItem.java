...
import net.mcreator.narutounleashed.entity.renderer.WoodColumnRenderer;
import net.mcreator.narutounleashed.NarutoUnleashedModElements;

import java.util.Random;

@NarutoUnleashedModElements.ModElement.Tag
public class WoodColumnItem extends NarutoUnleashedModElements.ModElement {
	@ObjectHolder("naruto_unleashed:wood_column")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletwood_column").setRegistryName("entitybulletwood_column");

	public WoodColumnItem(NarutoUnleashedModElements instance) {
		super(instance, 515);
		FMLJavaModLoadingContext.get().getModEventBus().register(new WoodColumnRenderer.ModelRegisterHandler());
	}

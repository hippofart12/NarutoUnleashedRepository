...
public class FrontLotusItemInInventoryTickProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				NarutoUnleashedMod.LOGGER.warn("Failed to load dependency entity for procedure FrontLotusItemInInventoryTick!");
			return;
		}
		...
		if (!((entity.getCapability(NarutoUnleashedModVariables.PLAYER_VARIABLES_CAPABILITY, null)
			...
			if (entity instanceof PlayerEntity) {
				ItemStack _stktoremove = new ItemStack(FrontLotusItem.block);

...
@OnlyIn(Dist.CLIENT)
public class AmaterasuAndTsukuyomiGuiGuiWindow extends ContainerScreen<AmaterasuAndTsukuyomiGuiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = AmaterasuAndTsukuyomiGuiGui.guistate;

	public AmaterasuAndTsukuyomiGuiGuiWindow(AmaterasuAndTsukuyomiGuiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("naruto_unleashed:textures/amaterasu_and_tsukuyomi_gui.png");
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Amaterasu And Tsukuyomi Jutsu", -29, -2, -16777216);
		...
		this.font.drawString(ms, "Tsukuyomi", 78, 106, -16777216);
		this.font.drawString(ms, "Jutsu Combo: 403", 78, 115, -12829636);
		this.font.drawString(ms, "700 Chakra", 78, 124, -12829636);
	}
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 168, this.guiTop + 151, 45, 20, new StringTextComponent("Back"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new AmaterasuAndTsukuyomiGuiGui.ButtonPressedMessage(0, x, y, z));
				AmaterasuAndTsukuyomiGuiGui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}

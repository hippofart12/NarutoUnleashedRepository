...
@OnlyIn(Dist.CLIENT)
public class KotoamatsukamiGuiGuiWindow extends ContainerScreen<KotoamatsukamiGuiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = KotoamatsukamiGuiGui.guistate;

	public KotoamatsukamiGuiGuiWindow(KotoamatsukamiGuiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("naruto_unleashed:textures/kotoamatsukami_gui.png");
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Kotoamatsukami", -29, -2, -16777216);
		...
		this.font.drawString(ms, "Kotoamatsukami", -29, 43, -16777216);
		this.font.drawString(ms, "Jutsu Combo: 600", -29, 52, -12829636);
		this.font.drawString(ms, "1200 Chakra", -29, 61, -12829636);
	}
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 168, this.guiTop + 151, 45, 20, new StringTextComponent("Back"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new KotoamatsukamiGuiGui.ButtonPressedMessage(0, x, y, z));
				KotoamatsukamiGuiGui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}

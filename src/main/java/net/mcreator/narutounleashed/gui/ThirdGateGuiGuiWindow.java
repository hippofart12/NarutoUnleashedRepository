...
@OnlyIn(Dist.CLIENT)
public class ThirdGateGuiGuiWindow extends ContainerScreen<ThirdGateGuiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = ThirdGateGuiGui.guistate;

	public ThirdGateGuiGuiWindow(ThirdGateGuiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("naruto_unleashed:textures/third_gate_gui.png");
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "The Gate Of Life", -29, -2, -16751104);
		...
		this.font.drawString(ms, "Requirements: 120 Taijutsu", -29, 43, -12829636);
		this.font.drawString(ms, "Cost: 9000 Jutsu Points", -29, 61, -12829636);
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 177, this.guiTop + 151, 30, 20, new StringTextComponent("Back"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new ThirdGateGuiGui.ButtonPressedMessage(0, x, y, z));
				ThirdGateGuiGui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 114, this.guiTop + 52, 50, 20, new StringTextComponent("Learn"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new ThirdGateGuiGui.ButtonPressedMessage(1, x, y, z));
				ThirdGateGuiGui.handleButtonAction(entity, 1, x, y, z);
			}
		}));
	}
}

...
@OnlyIn(Dist.CLIENT)
public class EyeTechniquesGuiGuiWindow extends ContainerScreen<EyeTechniquesGuiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = EyeTechniquesGuiGui.guistate;

	public EyeTechniquesGuiGuiWindow(EyeTechniquesGuiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("naruto_unleashed:textures/eye_techniques_gui.png");
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Eye Techniques", -29, -3, -16777216);
		...
		this.font.drawString(ms, "Sharingans", -29, 43, -3932160);
		this.font.drawString(ms, "Requires: Uchiha Clan", -29, 52, -1);
	}
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 177, this.guiTop + 151, 30, 20, new StringTextComponent("Back"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new EyeTechniquesGuiGui.ButtonPressedMessage(0, x, y, z));
				EyeTechniquesGuiGui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 96, this.guiTop + 43, 30, 20, new StringTextComponent("Go"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new EyeTechniquesGuiGui.ButtonPressedMessage(1, x, y, z));
				EyeTechniquesGuiGui.handleButtonAction(entity, 1, x, y, z);
			}
		}));
	}
}

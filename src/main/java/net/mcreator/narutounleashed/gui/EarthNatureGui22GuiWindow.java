...
@OnlyIn(Dist.CLIENT)
public class EarthNatureGui22GuiWindow extends ContainerScreen<EarthNatureGui22Gui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = EarthNatureGui22Gui.guistate;

	public EarthNatureGui22GuiWindow(EarthNatureGui22Gui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("naruto_unleashed:textures/earth_nature_gui_22.png");
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		...
		this.font.drawString(ms, "Stone Trap", -29, 43, -7589376);
		...
		this.font.drawString(ms, "Rock Rain Boulder Jutsu", 87, 70, -9619709);
		this.font.drawString(ms, "Requires: 5 Ninjutsu", -29, 79, -12829636);
		this.font.drawString(ms, "Jutsu Combo: 626", 105, 88, -13032697);
		this.font.drawString(ms, "1300 Jutsu Points", 105, 79, -6862336);
		this.font.drawString(ms, "626", 87, 97, -12829636);
		this.font.drawString(ms, "300 Chakra", 114, 97, -11654641);
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + -29, this.guiTop + 88, 30, 20, new StringTextComponent("Learn"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new EarthNatureGui22Gui.ButtonPressedMessage(0, x, y, z));
				EarthNatureGui22Gui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 87, this.guiTop + 115, 30, 20, new StringTextComponent("Learn"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new EarthNatureGui22Gui.ButtonPressedMessage(1, x, y, z));
				EarthNatureGui22Gui.handleButtonAction(entity, 1, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 141, this.guiTop + 151, 30, 20, new StringTextComponent("Back"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new EarthNatureGui22Gui.ButtonPressedMessage(2, x, y, z));
				EarthNatureGui22Gui.handleButtonAction(entity, 2, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 177, this.guiTop + 151, 30, 20, new StringTextComponent("Next"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new EarthNatureGui22Gui.ButtonPressedMessage(3, x, y, z));
				EarthNatureGui22Gui.handleButtonAction(entity, 3, x, y, z);
			}
		}));
	}
}

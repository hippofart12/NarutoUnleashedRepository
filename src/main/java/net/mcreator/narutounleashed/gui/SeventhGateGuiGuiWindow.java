...
@OnlyIn(Dist.CLIENT)
public class SeventhGateGuiGuiWindow extends ContainerScreen<SeventhGateGuiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = SeventhGateGuiGui.guistate;

	public SeventhGateGuiGuiWindow(SeventhGateGuiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("naruto_unleashed:textures/seventh_gate_gui.png");
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "The Gate Of Wonder", -29, -2, -16724788);
		...
		this.font.drawString(ms, "Requirements: 250 Taijutsu", -29, 43, -12829636);
		this.font.drawString(ms, "Cost: 16000 Jutsu Points", -29, 61, -12829636);
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 177, this.guiTop + 151, 30, 20, new StringTextComponent("Back"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new SeventhGateGuiGui.ButtonPressedMessage(0, x, y, z));
				SeventhGateGuiGui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 114, this.guiTop + 52, 50, 20, new StringTextComponent("Learn"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new SeventhGateGuiGui.ButtonPressedMessage(1, x, y, z));
				SeventhGateGuiGui.handleButtonAction(entity, 1, x, y, z);
			}
		}));
	}
}

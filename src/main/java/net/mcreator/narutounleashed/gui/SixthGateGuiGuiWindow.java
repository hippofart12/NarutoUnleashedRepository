...
@OnlyIn(Dist.CLIENT)
public class SixthGateGuiGuiWindow extends ContainerScreen<SixthGateGuiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = SixthGateGuiGui.guistate;

	public SixthGateGuiGuiWindow(SixthGateGuiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("naruto_unleashed:textures/sixth_gate_gui.png");
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "The Gate Of View", -29, -2, -16751104);
		...
		this.font.drawString(ms, "Requirements: 200 Taijutsu", -29, 43, -12829636);
		this.font.drawString(ms, "Cost: 13000 Jutsu Points", -29, 61, -12829636);
		...
		this.font.drawString(ms, "Reverse Lotus", -29, 133, -16751104);
		this.font.drawString(ms, "Can Be Used 3-8 Gates", -29, 142, -16751104);
		this.font.drawString(ms, "Morning Peacock", 69, 115, -16751104);
		this.font.drawString(ms, "Can Be Used 6-8 Gates", 69, 124, -16751104);
	}
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 177, this.guiTop + 151, 30, 20, new StringTextComponent("Back"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new SixthGateGuiGui.ButtonPressedMessage(0, x, y, z));
				SixthGateGuiGui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 114, this.guiTop + 52, 50, 20, new StringTextComponent("Learn"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new SixthGateGuiGui.ButtonPressedMessage(1, x, y, z));
				SixthGateGuiGui.handleButtonAction(entity, 1, x, y, z);
			}
		}));
	}
}

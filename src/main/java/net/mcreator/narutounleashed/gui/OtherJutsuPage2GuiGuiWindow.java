...
@OnlyIn(Dist.CLIENT)
public class OtherJutsuPage2GuiGuiWindow extends ContainerScreen<OtherJutsuPage2GuiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = OtherJutsuPage2GuiGui.guistate;

	public OtherJutsuPage2GuiGuiWindow(OtherJutsuPage2GuiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("naruto_unleashed:textures/other_jutsu_page_2_gui.png");
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		...
		this.font.drawString(ms, "Medical", -29, 16, -16777216);
		this.font.drawString(ms, "3 Jutsu", 6, 25, -12829636);
		this.font.drawString(ms, "Taijutsu", -29, 52, -16777216);
		this.font.drawString(ms, "8 Jutsus", 5, 63, -12829636);
		this.font.drawString(ms, "Uzumaki Jutsu", -29, 88, -16777216);
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + -29, this.guiTop + 25, 30, 20, new StringTextComponent("Go"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new OtherJutsuPage2GuiGui.ButtonPressedMessage(0, x, y, z));
				OtherJutsuPage2GuiGui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + 177, this.guiTop + 151, 30, 20, new StringTextComponent("Back"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new OtherJutsuPage2GuiGui.ButtonPressedMessage(1, x, y, z));
				OtherJutsuPage2GuiGui.handleButtonAction(entity, 1, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + -29, this.guiTop + 61, 30, 20, new StringTextComponent("Go"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new OtherJutsuPage2GuiGui.ButtonPressedMessage(2, x, y, z));
				OtherJutsuPage2GuiGui.handleButtonAction(entity, 2, x, y, z);
			}
		}));
		this.addButton(new Button(this.guiLeft + -29, this.guiTop + 97, 30, 20, new StringTextComponent("Go"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new OtherJutsuPage2GuiGui.ButtonPressedMessage(3, x, y, z));
				OtherJutsuPage2GuiGui.handleButtonAction(entity, 3, x, y, z);
			}
		}));
	}
}

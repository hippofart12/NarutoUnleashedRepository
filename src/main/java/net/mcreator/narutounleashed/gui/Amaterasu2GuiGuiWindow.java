...
@OnlyIn(Dist.CLIENT)
public class Amaterasu2GuiGuiWindow extends ContainerScreen<Amaterasu2GuiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = Amaterasu2GuiGui.guistate;

	public Amaterasu2GuiGuiWindow(Amaterasu2GuiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("naruto_unleashed:textures/amaterasu_2_gui.png");
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 168, this.guiTop + 151, 45, 20, new StringTextComponent("Back"), e -> {
			if (true) {
				NarutoUnleashedMod.PACKET_HANDLER.sendToServer(new Amaterasu2GuiGui.ButtonPressedMessage(0, x, y, z));
				Amaterasu2GuiGui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}

...
import net.mcreator.narutounleashed.entity.renderer.AliveDiamondOreRenderer;
import net.mcreator.narutounleashed.NarutoUnleashedModElements;

@NarutoUnleashedModElements.ModElement.Tag
public class AliveDiamondOreEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("alive_diamond_ore").setRegistryName("alive_diamond_ore");

	public AliveDiamondOreEntity(NarutoUnleashedModElements instance) {
		super(instance, 370);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AliveDiamondOreRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new BreakBlockGoal(Blocks.DIAMOND_ORE, this, 1, (int) 12));

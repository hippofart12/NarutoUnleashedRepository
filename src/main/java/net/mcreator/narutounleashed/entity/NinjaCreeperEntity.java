...
import net.mcreator.narutounleashed.procedures.NinjaCreeperTickProcedure;
import net.mcreator.narutounleashed.procedures.NinjaCreeperDeathProcedure;
import net.mcreator.narutounleashed.itemgroup.NarutoUnleashedTabItemGroup;
import net.mcreator.narutounleashed.entity.renderer.NinjaCreeperRenderer;
...
public class NinjaCreeperEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("ninja_creeper").setRegistryName("ninja_creeper");

	public NinjaCreeperEntity(NarutoUnleashedModElements instance) {
		super(instance, 1017);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NinjaCreeperRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16285184, -11591164, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab))
				.setRegistryName("ninja_creeper_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void onDeath(DamageSource source) {
			...
			NinjaCreeperDeathProcedure.executeProcedure(Stream
		...
		public void baseTick() {
			...
			NinjaCreeperTickProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),

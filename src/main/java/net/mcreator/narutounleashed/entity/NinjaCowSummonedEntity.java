...
import net.mcreator.narutounleashed.entity.renderer.NinjaCowSummonedRenderer;
...
public class NinjaCowSummonedEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("ninja_cow_summoned").setRegistryName("ninja_cow_summoned");

	public NinjaCowSummonedEntity(NarutoUnleashedModElements instance) {
		super(instance, 1031);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NinjaCowSummonedRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15266299, -16777063, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab))
				.setRegistryName("ninja_cow_summoned_spawn_egg"));
	}

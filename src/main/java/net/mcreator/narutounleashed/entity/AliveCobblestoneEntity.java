...
import net.mcreator.narutounleashed.entity.renderer.AliveCobblestoneRenderer;
import net.mcreator.narutounleashed.NarutoUnleashedModElements;

@NarutoUnleashedModElements.ModElement.Tag
public class AliveCobblestoneEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("alive_cobblestone").setRegistryName("alive_cobblestone");

	public AliveCobblestoneEntity(NarutoUnleashedModElements instance) {
		super(instance, 368);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AliveCobblestoneRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new BreakBlockGoal(Blocks.COBBLESTONE, this, 1, (int) 5));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Blocks.STONE));
		}

...
import net.mcreator.narutounleashed.entity.ItachiEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class ItachiRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ItachiEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelitachi(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_unleashed:textures/itachi.png");
					}
				};
			});
		}
	...
	public static class Modelitachi extends EntityModel<Entity> {
		...
		public Modelitachi() {
			...
			head.setTextureOffset(0, 40).addBox(-4.0F, -8.0F, 4.0F, 8.0F, 6.0F, 2.0F, 0.0F, false);
			head.setTextureOffset(0, 40).addBox(-3.0F, -2.0F, 4.0F, 6.0F, 4.0F, 2.0F, 0.0F, false);
			head.setTextureOffset(0, 39).addBox(-1.0F, 2.0F, 4.0F, 2.0F, 4.0F, 2.0F, 0.0F, false);
			head.setTextureOffset(9, 0).addBox(-4.0F, -8.0F, -5.0F, 1.0F, 6.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(9, 0).addBox(3.0F, -8.0F, -5.0F, 1.0F, 6.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(9, 0).addBox(-3.0F, -8.0F, -5.0F, 1.0F, 4.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(9, 0).addBox(2.0F, -8.0F, -5.0F, 1.0F, 4.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(9, 0).addBox(-2.0F, -8.0F, -5.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(9, 0).addBox(1.0F, -8.0F, -5.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);

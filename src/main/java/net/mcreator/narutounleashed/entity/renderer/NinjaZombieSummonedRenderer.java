...
@OnlyIn(Dist.CLIENT)
public class NinjaZombieSummonedRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NinjaZombieSummonedEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelZombieNinja(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_unleashed:textures/zombie.png");
					}
				};
			});
		}

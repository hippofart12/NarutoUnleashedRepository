...
@OnlyIn(Dist.CLIENT)
public class NinjaCowSummonedRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NinjaCowSummonedEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelNinjacow(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_unleashed:textures/cow.png");
					}
				};
			});
		}
	...
	public static class ModelNinjacow extends EntityModel<Entity> {
		...
		public ModelNinjacow() {
			...
			leg0.setTextureOffset(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.0F, true);
			...
			leg2.setTextureOffset(0, 16).addBox(-2.0F, 0.0F, -1.0F, 4.0F, 12.0F, 4.0F, 0.0F, true);

...
@OnlyIn(Dist.CLIENT)
public class Pain5Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Pain5Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelpain5(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_unleashed:textures/pain5.png");
					}
				};
			});
		}
	...
	public static class Modelpain5 extends EntityModel<Entity> {
		...
		public Modelpain5() {
			...
			head.setTextureOffset(34, 0).addBox(-4.0F, -8.0F, 4.0F, 8.0F, 8.0F, 1.0F, 0.0F, false);
			head_r1 = new ModelRenderer(this);
			head_r1.setRotationPoint(0.0F, 31.0F, 11.0F);
			head.addChild(head_r1);
			setRotationAngle(head_r1, 0.3491F, 0.0F, 0.0F);
			head_r1.setTextureOffset(34, 0).addBox(-4.0F, -32.0F, 4.0F, 8.0F, 2.0F, 1.0F, 0.0F, false);

...
@OnlyIn(Dist.CLIENT)
public class ThunderBoltRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ThunderBoltItem.arrow, renderManager -> new CustomRender(renderManager));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public static class CustomRender extends EntityRenderer<ThunderBoltItem.ArrowCustomEntity> {
		...
		@Override
		public void render(ThunderBoltItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
		...
		@Override
		public ResourceLocation getEntityTexture(ThunderBoltItem.ArrowCustomEntity entity) {
			return texture;
		}
	}

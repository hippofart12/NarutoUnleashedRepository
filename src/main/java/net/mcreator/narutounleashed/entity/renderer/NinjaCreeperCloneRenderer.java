...
import net.mcreator.narutounleashed.entity.NinjaCreeperCloneEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class NinjaCreeperCloneRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NinjaCreeperCloneEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelNinjacreeper(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_unleashed:textures/creeperclone.png");
					}
				};
			});
		}
	...
	public static class ModelNinjacreeper extends EntityModel<Entity> {

...
@OnlyIn(Dist.CLIENT)
public class KonanRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(KonanEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelkonan(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_unleashed:textures/konan.png");
					}
				};
			});
		}
	...
	public static class Modelkonan extends EntityModel<Entity> {

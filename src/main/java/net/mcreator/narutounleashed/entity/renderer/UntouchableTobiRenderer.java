...
import net.mcreator.narutounleashed.entity.UntouchableTobiEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class UntouchableTobiRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(UntouchableTobiEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelobito(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_unleashed:textures/obito.png");
					}
				};
			});
		}
	...
	public static class Modelobito extends EntityModel<Entity> {

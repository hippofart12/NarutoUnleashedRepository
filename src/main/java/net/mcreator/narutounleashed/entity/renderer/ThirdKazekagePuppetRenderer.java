...
@OnlyIn(Dist.CLIENT)
public class ThirdKazekagePuppetRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ThirdKazekagePuppetEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelmarioneteThirdKaze(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_unleashed:textures/marionete_-_third_kazekage.png");
					}
				};
			});
			RenderingRegistry.registerEntityRenderingHandler(ThirdKazekagePuppetEntity.arrow,

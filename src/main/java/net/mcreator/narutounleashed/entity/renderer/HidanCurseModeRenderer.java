...
@OnlyIn(Dist.CLIENT)
public class HidanCurseModeRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(HidanCurseModeEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelhidanCurseMode(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_unleashed:textures/hidan-curse_mode.png");
					}
				};
			});
		}

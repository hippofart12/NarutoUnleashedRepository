...
public class ChidoriSenbonRenderer {
	...
	public static class CustomRender extends EntityRenderer<ChidoriSenbonItem.ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("naruto_unleashed:textures/chidori_senbon.png");
	...
	public static class ModelChidoriSenbon extends EntityModel<Entity> {
		...
		public ModelChidoriSenbon() {
			...
			bb_main.setTextureOffset(0, 0).addBox(-0.25F, -15.0F, 0.0F, 0.0F, 15.0F, 0.0F, 0.0F, false);
		}

...
@OnlyIn(Dist.CLIENT)
public class Pain4Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Pain4Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelpain4(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_unleashed:textures/pain4.png");
					}
				};
			});
		}
	...
	public static class Modelpain4 extends EntityModel<Entity> {
		...
		public Modelpain4() {
			...
			head.setTextureOffset(34, 0).addBox(1.0F, 3.0F, 7.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(34, 0).addBox(-1.0F, 3.0F, 7.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(34, 0).addBox(-2.0F, 3.0F, 7.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(34, 0).addBox(-2.0F, 3.0F, 6.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(34, 0).addBox(-2.0F, 3.0F, 5.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(34, 0).addBox(-2.0F, 3.0F, 4.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(34, 0).addBox(0.0F, 3.0F, 4.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(34, 0).addBox(1.0F, 3.0F, 4.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(34, 0).addBox(1.0F, 3.0F, 5.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(34, 0).addBox(1.0F, 3.0F, 6.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(34, 0).addBox(-1.0F, 3.0F, 4.0F, 1.0F, 1.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(34, 0).addBox(0.0F, 3.0F, 7.0F, 1.0F, 2.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(34, 0).addBox(-2.0F, -9.0F, 4.0F, 4.0F, 12.0F, 4.0F, 0.0F, false);
			head.setTextureOffset(35, 0).addBox(-5.0F, -8.0F, -3.0F, 1.0F, 10.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(27, 0).addBox(-5.0F, -8.0F, -5.0F, 1.0F, 7.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(33, 0).addBox(-5.0F, -8.0F, -4.0F, 1.0F, 9.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(10, 0).addBox(-4.0F, -8.0F, -5.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);
			head.setTextureOffset(36, 0).addBox(-5.0F, -8.0F, -2.0F, 1.0F, 7.0F, 1.0F, 0.0F, false);

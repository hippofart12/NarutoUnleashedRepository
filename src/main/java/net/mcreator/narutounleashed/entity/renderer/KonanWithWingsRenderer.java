...
@OnlyIn(Dist.CLIENT)
public class KonanWithWingsRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(KonanWithWingsEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelkonanwithwings(), 0.5f) {

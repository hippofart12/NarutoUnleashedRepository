...
@OnlyIn(Dist.CLIENT)
public class NinjaCreeperRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NinjaCreeperEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelNinjacreeper(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_unleashed:textures/creeper.png");
					}
				};
			});
		}

...
@OnlyIn(Dist.CLIENT)
public class KisameRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(KisameEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelkisame(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_unleashed:textures/kisame.png");
					}
				};
			});
		}

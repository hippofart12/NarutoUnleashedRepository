...
import net.mcreator.narutounleashed.entity.KakazuEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class KakazuRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(KakazuEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelkakuzo1(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_unleashed:textures/kakuzo.png");
					}
				};
			});
		}
	...
	public static class Modelkakuzo1 extends EntityModel<Entity> {

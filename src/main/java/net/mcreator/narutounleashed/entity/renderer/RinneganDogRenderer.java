...
import net.mcreator.narutounleashed.entity.RinneganDogEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class RinneganDogRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(RinneganDogEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelanimal5(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("naruto_unleashed:textures/animal5.png");
					}
				};
			});
		}
	...
	public static class Modelanimal5 extends EntityModel<Entity> {
		...
		public Modelanimal5() {
			...
			pernadireita_r1.setTextureOffset(112, 112).addBox(-10.3296F, -9.2017F, -10.9696F, 5.0F, 9.0F, 6.0F, 0.0F, false);
			...
			pernadireitaATRAS_r1.setTextureOffset(84, 113).addBox(-10.1553F, -10.7126F, 9.0725F, 5.0F, 8.0F, 6.0F, 0.0F, false);
			...
			pernadireitaATRAS_r2.setTextureOffset(96, 96).addBox(-10.2424F, -15.7477F, 12.4928F, 5.0F, 11.0F, 6.0F, 0.0F, false);
			...
			pernaesquerdaATRAS_r1.setTextureOffset(16, 114).addBox(5.1553F, -10.7126F, 9.0725F, 5.0F, 8.0F, 6.0F, 0.0F, false);
			...
			pernaesquerdaATRAS_r2.setTextureOffset(0, 0).addBox(5.2424F, -15.7477F, 12.4928F, 5.0F, 11.0F, 6.0F, 0.0F, false);
		}

...
public class SteelProjectileRenderer {
	...
	public static class CustomRender extends EntityRenderer<SteelProjectileItem.ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("naruto_unleashed:textures/steel_projectile.png");
		...
		public void render(SteelProjectileItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
			...
			EntityModel model = new ModelSteel_Projectile();
	...
	public static class ModelSteel_Projectile extends EntityModel<Entity> {
		private final ModelRenderer bb_main;

		public ModelSteel_Projectile() {
			textureWidth = 16;
			textureHeight = 16;

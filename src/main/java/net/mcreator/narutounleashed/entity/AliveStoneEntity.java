...
import net.mcreator.narutounleashed.entity.renderer.AliveStoneRenderer;
import net.mcreator.narutounleashed.NarutoUnleashedModElements;

@NarutoUnleashedModElements.ModElement.Tag
public class AliveStoneEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("alive_stone").setRegistryName("alive_stone");

	public AliveStoneEntity(NarutoUnleashedModElements instance) {
		super(instance, 363);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AliveStoneRenderer.ModelRegisterHandler());

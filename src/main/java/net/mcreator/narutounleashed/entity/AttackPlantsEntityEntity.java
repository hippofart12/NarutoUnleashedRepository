...
import net.mcreator.narutounleashed.procedures.AttackPlantsEntityOnEntityTickUpdateProcedure;
import net.mcreator.narutounleashed.entity.renderer.AttackPlantsEntityRenderer;
...
public class AttackPlantsEntityEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("attack_plants_entity").setRegistryName("attack_plants_entity");

	public AttackPlantsEntityEntity(NarutoUnleashedModElements instance) {
		super(instance, 1423);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AttackPlantsEntityRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void baseTick() {
			...
			AttackPlantsEntityOnEntityTickUpdateProcedure.executeProcedure(Stream

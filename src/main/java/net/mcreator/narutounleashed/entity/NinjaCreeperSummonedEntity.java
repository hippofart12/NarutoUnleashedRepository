...
import net.mcreator.narutounleashed.entity.renderer.NinjaCreeperSummonedRenderer;
...
public class NinjaCreeperSummonedEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("ninja_creeper_summoned").setRegistryName("ninja_creeper_summoned");

	public NinjaCreeperSummonedEntity(NarutoUnleashedModElements instance) {
		super(instance, 1033);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NinjaCreeperSummonedRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16285184, -11591164, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab))
				.setRegistryName("ninja_creeper_summoned_spawn_egg"));
	}

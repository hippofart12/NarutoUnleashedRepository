...
import net.mcreator.narutounleashed.procedures.NinjaZombieOnEntityTickUpdateProcedure;
import net.mcreator.narutounleashed.procedures.NinjaZombieEntityDiesProcedure;
import net.mcreator.narutounleashed.itemgroup.NarutoUnleashedTabItemGroup;
import net.mcreator.narutounleashed.entity.renderer.NinjaZombieRenderer;
...
public class NinjaZombieEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("ninja_zombie").setRegistryName("ninja_zombie");

	public NinjaZombieEntity(NarutoUnleashedModElements instance) {
		super(instance, 1008);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NinjaZombieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16751104, -16777063, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab))
				.setRegistryName("ninja_zombie_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void onDeath(DamageSource source) {
			...
			NinjaZombieEntityDiesProcedure.executeProcedure(Stream
		...
		public void baseTick() {
			...
			NinjaZombieOnEntityTickUpdateProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}

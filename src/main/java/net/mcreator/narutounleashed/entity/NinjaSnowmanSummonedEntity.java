...
import net.mcreator.narutounleashed.entity.renderer.NinjaSnowmanSummonedRenderer;
...
public class NinjaSnowmanSummonedEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("ninja_snowman_summoned").setRegistryName("ninja_snowman_summoned");

	public NinjaSnowmanSummonedEntity(NarutoUnleashedModElements instance) {
		super(instance, 1032);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NinjaSnowmanSummonedRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -8487185, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab))
				.setRegistryName("ninja_snowman_summoned_spawn_egg"));
	}

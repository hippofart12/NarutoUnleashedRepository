...
import net.mcreator.narutounleashed.procedures.SasoriOnEntityTickUpdateProcedure;
import net.mcreator.narutounleashed.procedures.SasoriNaturalEntitySpawningConditionProcedure;
import net.mcreator.narutounleashed.procedures.SasoriEntityDiesProcedure;
import net.mcreator.narutounleashed.itemgroup.NarutoUnleashedTabItemGroup;
import net.mcreator.narutounleashed.entity.renderer.SasoriRenderer;
...
public class SasoriEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1f, 1.4f)).build("sasori").setRegistryName("sasori");

	public SasoriEntity(NarutoUnleashedModElements instance) {
		super(instance, 412);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SasoriRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -6750208, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab))
				.setRegistryName("sasori_spawn_egg"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return SasoriNaturalEntitySpawningConditionProcedure.executeProcedure(Stream
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			SasoriEntityDiesProcedure.executeProcedure(Stream
		...
		public void baseTick() {
			...
			SasoriOnEntityTickUpdateProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),

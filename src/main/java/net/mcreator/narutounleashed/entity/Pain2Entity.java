...
import net.mcreator.narutounleashed.procedures.Pain2OnEntityTickUpdateProcedure;
import net.mcreator.narutounleashed.procedures.Pain2NaturalspawnProcedure;
import net.mcreator.narutounleashed.itemgroup.NarutoUnleashedTabItemGroup;
import net.mcreator.narutounleashed.entity.renderer.Pain2Renderer;
...
public class Pain2Entity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("pain_2").setRegistryName("pain_2");

	public Pain2Entity(NarutoUnleashedModElements instance) {
		super(instance, 546);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Pain2Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -6750208, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab))
				.setRegistryName("pain_2_spawn_egg"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return Pain2NaturalspawnProcedure.executeProcedure(Stream
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(5, new AvoidEntityGoal(this, PlayerEntity.class, (float) 12, 1, 1.2));
		}
		...
		public void baseTick() {
			...
			Pain2OnEntityTickUpdateProcedure.executeProcedure(Stream

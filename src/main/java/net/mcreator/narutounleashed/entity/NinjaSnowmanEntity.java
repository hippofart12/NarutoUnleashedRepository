...
import net.mcreator.narutounleashed.procedures.NinjaSnowmanTickProcedure;
import net.mcreator.narutounleashed.procedures.NinjaSnowmanDeathProcedure;
import net.mcreator.narutounleashed.itemgroup.NarutoUnleashedTabItemGroup;
import net.mcreator.narutounleashed.entity.renderer.NinjaSnowmanRenderer;
...
public class NinjaSnowmanEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("ninja_snowman").setRegistryName("ninja_snowman");

	public NinjaSnowmanEntity(NarutoUnleashedModElements instance) {
		super(instance, 1015);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NinjaSnowmanRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -8487185, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab))
				.setRegistryName("ninja_snowman_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void onDeath(DamageSource source) {
			...
			NinjaSnowmanDeathProcedure.executeProcedure(Stream
		...
		public void baseTick() {
			...
			NinjaSnowmanTickProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}

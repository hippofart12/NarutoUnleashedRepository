...
import net.mcreator.narutounleashed.entity.renderer.NinjaZombieSummonedRenderer;
...
public class NinjaZombieSummonedEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("ninja_zombie_summoned").setRegistryName("ninja_zombie_summoned");

	public NinjaZombieSummonedEntity(NarutoUnleashedModElements instance) {
		super(instance, 1028);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NinjaZombieSummonedRenderer.ModelRegisterHandler());

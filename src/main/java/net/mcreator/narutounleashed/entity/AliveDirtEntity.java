...
import net.mcreator.narutounleashed.entity.renderer.AliveDirtRenderer;
import net.mcreator.narutounleashed.NarutoUnleashedModElements;

@NarutoUnleashedModElements.ModElement.Tag
public class AliveDirtEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("alive_dirt").setRegistryName("alive_dirt");

	public AliveDirtEntity(NarutoUnleashedModElements instance) {
		super(instance, 371);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AliveDirtRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new BreakBlockGoal(Blocks.DIRT, this, 1, (int) 5));

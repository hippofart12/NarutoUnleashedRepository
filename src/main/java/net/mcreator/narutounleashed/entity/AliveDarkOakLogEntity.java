...
import net.mcreator.narutounleashed.entity.renderer.AliveDarkOakLogRenderer;
import net.mcreator.narutounleashed.NarutoUnleashedModElements;

@NarutoUnleashedModElements.ModElement.Tag
public class AliveDarkOakLogEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("alive_dark_oak_log").setRegistryName("alive_dark_oak_log");

	public AliveDarkOakLogEntity(NarutoUnleashedModElements instance) {
		super(instance, 369);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AliveDarkOakLogRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new BreakBlockGoal(Blocks.DARK_OAK_LOG, this, 1, (int) 5));

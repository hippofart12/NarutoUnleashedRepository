...
import net.mcreator.narutounleashed.procedures.NinjaCowTickProcedure;
import net.mcreator.narutounleashed.procedures.NinjaCowDeathProcedure;
import net.mcreator.narutounleashed.itemgroup.NarutoUnleashedTabItemGroup;
import net.mcreator.narutounleashed.entity.renderer.NinjaCowRenderer;
...
public class NinjaCowEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("ninja_cow").setRegistryName("ninja_cow");

	public NinjaCowEntity(NarutoUnleashedModElements instance) {
		super(instance, 1013);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NinjaCowRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15266299, -16777063, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab))
				.setRegistryName("ninja_cow_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void onDeath(DamageSource source) {
			...
			NinjaCowDeathProcedure.executeProcedure(Stream
		...
		public void baseTick() {
			...
			NinjaCowTickProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}

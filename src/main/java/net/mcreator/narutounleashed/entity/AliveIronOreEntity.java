...
import net.mcreator.narutounleashed.entity.renderer.AliveIronOreRenderer;
import net.mcreator.narutounleashed.NarutoUnleashedModElements;

@NarutoUnleashedModElements.ModElement.Tag
public class AliveIronOreEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("alive_iron_ore").setRegistryName("alive_iron_ore");

	public AliveIronOreEntity(NarutoUnleashedModElements instance) {
		super(instance, 375);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AliveIronOreRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Blocks.IRON_ORE));
		}

...
import net.mcreator.narutounleashed.procedures.HidanOnEntityTickUpdateProcedure;
import net.mcreator.narutounleashed.procedures.HidanNaturalEntitySpawningConditionProcedure;
import net.mcreator.narutounleashed.itemgroup.NarutoUnleashedTabItemGroup;
import net.mcreator.narutounleashed.entity.renderer.HidanRenderer;
...
public class HidanEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("hidan").setRegistryName("hidan");

	public HidanEntity(NarutoUnleashedModElements instance) {
		super(instance, 486);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HidanRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -6750208, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab))
				.setRegistryName("hidan_spawn_egg"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return HidanNaturalEntitySpawningConditionProcedure.executeProcedure(Stream
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void baseTick() {
			...
			HidanOnEntityTickUpdateProcedure.executeProcedure(Stream

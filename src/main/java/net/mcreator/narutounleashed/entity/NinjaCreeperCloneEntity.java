...
import net.mcreator.narutounleashed.procedures.NinjaCreeperCloneOnEntityTickUpdateProcedure;
import net.mcreator.narutounleashed.itemgroup.NarutoUnleashedTabItemGroup;
import net.mcreator.narutounleashed.entity.renderer.NinjaCreeperCloneRenderer;
...
public class NinjaCreeperCloneEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("ninja_creeper_clone").setRegistryName("ninja_creeper_clone");

	public NinjaCreeperCloneEntity(NarutoUnleashedModElements instance) {
		super(instance, 1018);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NinjaCreeperCloneRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16285184, -11591164, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab))
				.setRegistryName("ninja_creeper_clone_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void baseTick() {
			...
			NinjaCreeperCloneOnEntityTickUpdateProcedure.executeProcedure(Stream

...
import net.mcreator.narutounleashed.entity.renderer.SasoriPuppet2Renderer;
...
public class SasoriPuppet2Entity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("sasori_puppet_2").setRegistryName("sasori_puppet_2");

	public SasoriPuppet2Entity(NarutoUnleashedModElements instance) {
		super(instance, 420);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SasoriPuppet2Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10206951, -13689329, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("sasori_puppet_2_spawn_egg"));
	}

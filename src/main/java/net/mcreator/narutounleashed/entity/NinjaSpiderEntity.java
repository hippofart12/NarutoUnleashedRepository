...
import net.mcreator.narutounleashed.procedures.NinjaSpiderDeathProcedure;
import net.mcreator.narutounleashed.itemgroup.NarutoUnleashedTabItemGroup;
import net.mcreator.narutounleashed.entity.renderer.NinjaSpiderRenderer;
...
public class NinjaSpiderEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("ninja_spider").setRegistryName("ninja_spider");

	public NinjaSpiderEntity(NarutoUnleashedModElements instance) {
		super(instance, 1011);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NinjaSpiderRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15725302, -1121262, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab))
				.setRegistryName("ninja_spider_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public void onDeath(DamageSource source) {
			...
			NinjaSpiderDeathProcedure.executeProcedure(Stream

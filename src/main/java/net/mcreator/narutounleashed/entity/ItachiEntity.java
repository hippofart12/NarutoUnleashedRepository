...
import net.mcreator.narutounleashed.procedures.ItachiOnEntityTickUpdateProcedure;
import net.mcreator.narutounleashed.procedures.ItachiNaturalEntitySpawningConditionProcedure;
import net.mcreator.narutounleashed.itemgroup.NarutoUnleashedTabItemGroup;
import net.mcreator.narutounleashed.item.ItachisRingItem;
import net.mcreator.narutounleashed.entity.renderer.ItachiRenderer;
...
public class ItachiEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("itachi").setRegistryName("itachi");

	public ItachiEntity(NarutoUnleashedModElements instance) {
		super(instance, 500);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ItachiRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -6750208, new Item.Properties().group(NarutoUnleashedTabItemGroup.tab))
				.setRegistryName("itachi_spawn_egg"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return ItachiNaturalEntitySpawningConditionProcedure.executeProcedure(Stream
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(ItachisRingItem.block));
		}
		...
		public void baseTick() {
			...
			ItachiOnEntityTickUpdateProcedure.executeProcedure(Stream

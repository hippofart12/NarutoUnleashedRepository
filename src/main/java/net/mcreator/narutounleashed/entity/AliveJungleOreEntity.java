...
import net.mcreator.narutounleashed.entity.renderer.AliveJungleOreRenderer;
import net.mcreator.narutounleashed.NarutoUnleashedModElements;

@NarutoUnleashedModElements.ModElement.Tag
public class AliveJungleOreEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("alive_jungle_ore").setRegistryName("alive_jungle_ore");

	public AliveJungleOreEntity(NarutoUnleashedModElements instance) {
		super(instance, 376);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AliveJungleOreRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new BreakBlockGoal(Blocks.JUNGLE_LOG, this, 1, (int) 5));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Blocks.JUNGLE_LOG));
		}

...
import net.mcreator.narutounleashed.entity.renderer.AliveBirchLogRenderer;
import net.mcreator.narutounleashed.NarutoUnleashedModElements;

@NarutoUnleashedModElements.ModElement.Tag
public class AliveBirchLogEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("alive_birch_log").setRegistryName("alive_birch_log");

	public AliveBirchLogEntity(NarutoUnleashedModElements instance) {
		super(instance, 365);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AliveBirchLogRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new BreakBlockGoal(Blocks.BIRCH_LOG, this, 1, (int) 5));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Blocks.BIRCH_WOOD));
		}

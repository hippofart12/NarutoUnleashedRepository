...
import net.mcreator.narutounleashed.entity.renderer.AliveEndStoneRenderer;
import net.mcreator.narutounleashed.NarutoUnleashedModElements;

@NarutoUnleashedModElements.ModElement.Tag
public class AliveEndStoneEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("alive_end_stone").setRegistryName("alive_end_stone");

	public AliveEndStoneEntity(NarutoUnleashedModElements instance) {
		super(instance, 373);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AliveEndStoneRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Blocks.END_STONE));
		}

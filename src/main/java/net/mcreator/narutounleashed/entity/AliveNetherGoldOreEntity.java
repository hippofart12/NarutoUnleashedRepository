...
import net.mcreator.narutounleashed.entity.renderer.AliveNetherGoldOreRenderer;
import net.mcreator.narutounleashed.NarutoUnleashedModElements;

@NarutoUnleashedModElements.ModElement.Tag
public class AliveNetherGoldOreEntity extends NarutoUnleashedModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("alive_nether_gold_ore").setRegistryName("alive_nether_gold_ore");

	public AliveNetherGoldOreEntity(NarutoUnleashedModElements instance) {
		super(instance, 378);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AliveNetherGoldOreRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new BreakBlockGoal(Blocks.STONE, this, 1, (int) 5));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Blocks.NETHER_GOLD_ORE));
		}

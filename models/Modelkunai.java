...
public static class Modelkunai extends ModelBase {
	...
	public Modelkunai() {
		...
		kunai.cubeList.add(new ModelBox(kunai, 50, 26, 0.0183F, -2.0F, -8.0F, 0, 2, 8, 0.0F, false));

		k1 = new ModelRenderer(this);
		k1.setRotationPoint(0.0009F, -0.4816F, -12.2491F);
		setRotationAngle(k1, 0.0F, 0.0F, -1.5708F);
		kunai.addChild(k1);
		k1.cubeList.add(new ModelBox(k1, 50, 26, 0.2679F, -1.2688F, 4.2491F, 0, 2, 8, 0.0F, false));
	}

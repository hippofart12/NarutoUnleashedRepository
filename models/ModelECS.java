...
public static class ModelECS extends ModelBase {
	...
	public ModelECS() {
		...
		Body.addChild(head);
		head.cubeList.add(new ModelBox(head, 22, 22, -5.0F, -4.0F, -3.75F, 4, 4, 4, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 0, 36, -5.75F, -3.0F, -7.75F, 1, 3, 4, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 28, 34, -1.25F, -3.0F, -7.75F, 1, 3, 4, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 34, 21, -5.5F, -2.25F, -8.5F, 1, 2, 3, 0.0F, false));
		head.cubeList.add(new ModelBox(head, 14, 24, -1.5F, -2.25F, -8.5F, 1, 2, 3, 0.0F, false));

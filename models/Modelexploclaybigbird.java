...
public static class Modelexploclaybigbird extends ModelBase {
	...
	public Modelexploclaybigbird() {
		...
		Body.addChild(Head);
		Head.cubeList.add(new ModelBox(Head, 0, 124, -14.0F, -56.0F, -68.0F, 32, 28, 28, 0.0F, false));

		flap1 = new ModelRenderer(this);
		flap1.setRotationPoint(2.0F, -56.0F, -54.0F);
		Head.addChild(flap1);
		flap1.cubeList.add(new ModelBox(flap1, 132, 0, -2.0F, -24.0F, -6.0F, 4, 24, 12, 0.0F, false));

		flap3 = new ModelRenderer(this);
		flap3.setRotationPoint(2.0F, -52.0F, -45.0F);
		...
		flap2.setRotationPoint(2.0F, -52.0F, -63.0F);
